...
/**
 * 消费者监听器
 * 1、注意：使用@RocketMQMessageListener注册监听器时，要在启动类的@SpringBootApplication注解中加上扫描rocketmq命令，否则消费者监听器注册不上
...
public class MqConsumer2 implements RocketMQListener<String> {
    @Override
    public void onMessage(String msg) {
        log.info("MqConsumer2:receive message: {}", msg);
    }
